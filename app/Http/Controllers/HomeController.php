...
class HomeController extends Controller
{
   ...
   {
      if (app('system_settings')->fields['frontend']) {
         $page = ProjectPage::where('type', 'home')->where('status', true)->with('project')->first();
   ...
   {
      if (app('system_settings')->fields['frontend'] && $request->slug != 'careers') {
