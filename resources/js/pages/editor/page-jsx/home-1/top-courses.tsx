   ...
   return (
      <EditorSection className="overflow-y-hidden bg-[url('/assets/images/intro/home-1/bg-line.png')] bg-cover bg-center py-20">
         <EditorContainer className="relative">
            ...
            <EditorDiv className="pointer-events-none absolute top-20 right-0 h-[240px] w-[240px] rounded-full bg-[rgba(97,95,255,1)] blur-[180px] content-['']"></EditorDiv>
            <EditorDiv className="pointer-events-none absolute bottom-20 left-0 h-[240px] w-[240px] rounded-full bg-[rgba(0,120,103,1)] blur-[180px] content-['']"></EditorDiv>
         </EditorContainer>
      </EditorSection>
   );
};
