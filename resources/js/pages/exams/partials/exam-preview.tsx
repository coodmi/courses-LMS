               ...
               <div className="space-y-4">
                  <h2 className="text-4xl font-bold capitalize">
                     {exam.pricing_type === 'free' ? (
                        ...
                        <>
                           <span className="font-semibold">{amount(exam.discount_price)}</span>
                           <span className="text-muted-foreground ml-2 text-base font-medium line-through">{amount(exam.price)}</span>
                        </>
                     ) : (
                        <>
