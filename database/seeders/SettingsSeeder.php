    ...
    public function run(): void
    {
        $settings = [
            [
                ...
                'fields' => [
                    'name' => 'Alpha LMS',
                    'title' => 'Alpha LMS - Learning Management System',
                    'keywords' => 'LMS, Learning Management System, Courses, Alpha LMS',
                    'description' => 'Transform your learning journey with Alpha LMS - a comprehensive online learning platform connecting expert instructors with passionate learners. Discover courses, build skills, and achieve your goals.',
                    'logo_dark' => '',
                    'logo_light' => '',
                    'favicon' => '/favicon.ico',
                    'banner' => '/banner.png',
